...
public class ReligionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionList.add(new Question("What is the predominant religion in Tunisia?", new String[]{"Christianity", "Hinduism", "Islam", "Buddhism"}, 2));
        questionList.add(new Question("What is the holy book of Islam?", new String[]{"Torah","Quran", "Bible",  "Tripitaka"}, 1));
        questionList.add(new Question("What is the name of the daily prayers performed by Muslims?", new String[]{ "Zakat", "Hajj","Salat", "Sawm"}, 2));
        questionList.add(new Question("Who is considered the final prophet in Islam?", new String[]{"Jesus", "Moses", "Muhammad", "Abraham"}, 2));
        questionList.add(new Question("What is the name of the month of fasting observed by Muslims worldwide?", new String[]{"Ramadan", "Shawwal", "Muharram", "Dhul-Hijjah"}, 0));
        questionList.add(new Question("What is the pilgrimage to Mecca called, which is one of the Five Pillars of Islam?", new String[]{"Umrah", "Tawaf", "Hajj", "Sadaqah"}, 2));
        questionList.add(new Question("Which Islamic holiday marks the end of Ramadan and is celebrated with communal prayers, feasting, and giving of gifts?", new String[]{"Eid al-Adha", "Eid al-Fitr", "Ashura","Mawlid"}, 1));
