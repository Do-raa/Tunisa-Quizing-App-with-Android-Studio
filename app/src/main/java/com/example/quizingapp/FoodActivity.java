...
public class FoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionList.add(new Question("What is the national dish of Tunisia, typically made from steamed semolina served with a stew of meat and vegetables?", new String[]{"Shakshuka", "Brik", "Couscous", "Harissa"}, 2));
        questionList.add(new Question("Which spicy chili paste, made from roasted red peppers, garlic, and various spices, is a staple condiment in Tunisian cuisine?", new String[]{"Ras el Hanout", "Za'atar", "Mechouia", "Harissa"}, 3));
        questionList.add(new Question("What is the traditional Tunisian soup made from pureed chickpeas, garlic, olive oil, and cumin called?", new String[]{ "Slata Tounsia", "Chorba","Merguez", "Lablebi"}, 3));
        questionList.add(new Question("Which Tunisian appetizer consists of thin pastry filled with egg, tuna, capers, and parsley, then deep-fried until crispy?", new String[]{"Kaak Warka", "Makroud", "Brik", "Samsa"}, 2));
        questionList.add(new Question("What is the name of the popular Tunisian salad made from roasted bell peppers, tomatoes, onions, and olive oil?", new String[]{"Mechouia", "Taktouka", "Salatat Tunisie", "Salade niçoise"}, 0));
        questionList.add(new Question("Which Tunisian dish consists of a spicy tomato and pepper sauce simmered with eggs, usually served for breakfast or brunch?", new String[]{"Tagine", "Shakshuka", "Merguez", "Kefta"}, 1));
        questionList.add(new Question("What is the traditional Tunisian dessert made from layers of thin pastry filled with almond paste and flavored with orange blossom water?", new String[]{"Baklava", "Makroud", "Ghrayba","Zlabia"}, 0));
